export const translations = {
  en: {
    ...
    product1Desc: 'Standardization and service-oriented standard system construction for a group supermarket data',
    product2Title: 'AI Workflow Automation Platform',
    product2Desc: 'Intelligent workflow platform based on n8n',
    product3Title: 'Mini Program Development',
    product3Desc: 'Enterprise recruitment mini program, local assistant mini program',
    product4Title: 'CRM System',
    product4Desc: 'Enterprise loan CRM system development',
    product5Title: 'Knowledge Base Platform',
    product5Desc: 'Audit issue knowledge base platform - regulations, issues, methods, and case study knowledge platform',
    product6Title: 'AI Voice Conversion Platform',
  ...
  zh: {
    ...
    product5Title: '知识库平台',
    product5Desc: '审计问题知识库平台- 法规、问题、方法、案例知识平台',
    product6Title: 'AI语音转换平台',
